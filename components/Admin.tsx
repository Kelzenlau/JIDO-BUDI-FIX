...
import { HomeConfig, GameConfig, AdsConfig, AnnouncementConfig } from '../types';
...
export const AdminConsole = ({ user }: { user: any }) => {
    ...
    // Fix: Typed configuration states to resolve property 'heroImage' errors and type mismatch comparisons
